...
from contracts import contract, new_contract, ContractException, decorate
from contracts.docstring_parsing import DocStringInfo
...
class Model(network.Network, version_utils.ModelVersionSelector):
  ...
  def fit(self,
    ...
    with self.distribute_strategy.scope(), \
      ...
      #step 1 : parse docstring to get user defined fuction name
      #step 2: if post condition enqbeld,
      # fun2(self.history)
      # out =10
      # docs = DocStringInfo.parse(self.fit.__doc__)
      # print(docs)
      # if hasattr(docs, 'returns'):
      #     funName = docs.returns[0].desc
      #     h =self.history
      #     globals()[funName](h)
      #h = self.history
      return self.history
  ...
  # def fun2(self):
  #     print('fun2 called', self.history)
